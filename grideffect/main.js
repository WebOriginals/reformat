...
;(function(window) {
	...
	GridFx.prototype._init = function() {
		...
		imagesLoaded( this.gridEl, function() {
			...
			new Masonry(self.gridEl, {
				...
				//isFitWidth : true
				// columnWidth: 270
				// columnWidth: $('.grid__item--1k').width()
			});
	 ...
	 * open a grid item
	 */
	GridFx.prototype._openItem = function(ev, item) { console.log("open");console.log(this.isAnimating);
	...
	GridFx.prototype._closeItem = function() { 
		...
		onEndTransition(this.originalImg, function() {
			...
			// При такой ширине, анимации не происходит
			if($(window).width() < 992) {
				self.isAnimating = false;
			}
